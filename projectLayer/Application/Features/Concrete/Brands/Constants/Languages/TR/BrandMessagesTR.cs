using eCommerceLayer.Application.Features.Concrete.Brands.Constants.Standart;
using eCommerceLayer.Application.Features.Base.Constants.Languages.TR.Base;

namespace eCommerceLayer.Application.Features.Concrete.Brands.Constants.Languages.TR
{
