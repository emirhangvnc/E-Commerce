using eCommerceLayer.Application.Features.Concrete.Categories.Constants.Standart;
using eCommerceLayer.Application.Features.Base.Constants.Languages.TR.Base;

namespace eCommerceLayer.Application.Features.Concrete.Categories.Constants.Languages.TR
{
