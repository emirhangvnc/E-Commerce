using projectLayer.Application.Features.Base.Constants.Standart.General;
using projectLayer.Application.Features.Base.Constants.Languages.TR.Base;

namespace projectLayer.Application.Features.Base.Constants.Languages.TR.General
{
